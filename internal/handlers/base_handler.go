...
type indexPageBaseHtml struct {
	Login bool
}

func BaseHandler(tmpl *template.Template) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		err := tmpl.ExecuteTemplate(w, selectors.IndexPage.BaseHTML, indexPageBaseHtml{Login: true})
		if err != nil {
...
func LoginHandler(tmpl *template.Template) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		err := tmpl.ExecuteTemplate(w, selectors.IndexPage.LoginComponent, indexPageBaseHtml{Login: true})
		if err != nil {
...
func SignUpHandler(tmpl *template.Template) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		err := tmpl.ExecuteTemplate(w, selectors.IndexPage.SignUpComponent, indexPageBaseHtml{Login: false})
		if err != nil {
